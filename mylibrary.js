...
//instrution at top
  ...
  /*
//
  function swpanbigsoilder(){

    if (keyCode===81  && energy>=75)
  {
    bigplayer1 = new Bigplayer(110,200,50,50);
    //energy = energy - 75;
    energy = energy - 1;
  }
  if(keyCode===87 && energy>=75)
  {
    bigplayer1 = new Bigplayer(110,400,50,50);
      // energy = energy - 75;
       energy = energy - 1;

  }
  if(keyCode===69 && energy>=75)
  {
    bigplayer1 = new Bigplayer(110,300,50,50);
       //energy = energy - 75;
       energy = energy - 1;
  }
  //to add the entire object player1 to an array
  //PlayerObjectGroup.push(bigplayer1);
  }
  */